...
export const TRY_TEST_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    variants: [
      { colorName: 'Dark Black', url: 'https://ik.imagekit.io/5yvgym2qm/tr:w-1000,h-1500/products/696e0bcb55259/69e69abfcec21productimage69e69a06054c4.jpg', tryOnImage: '/maverick-phoenix-black.png' },
      { colorName: 'White Base', url: 'https://ik.imagekit.io/5yvgym2qm/tr:w-1000,h-1500/products/696e0bcb55259/69e69abfcec21productimage69e69a06054c4.jpg', tryOnImage: '/maverick-phoenix-white.png' },
    ],
  },
]
...
export const PREORDER_PRODUCT: Product = {
  ...
  variants: [
    ...
    { colorName: 'Navy Blue', url: 'https://ik.imagekit.io/5yvgym2qm/tr:w-null,h-null//products/696e0bcb55259/69e1482150dd4productimage69e14759939d1.jpg', tryOnImage: '/eternity-protocol-navy.png' },
  ],
}
